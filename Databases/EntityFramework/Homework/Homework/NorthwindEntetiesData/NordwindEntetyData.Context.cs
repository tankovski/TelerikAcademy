...
namespace NorthwindEntetiesData
{
    using System;
    ...
    public partial class NorthwindEntities : DbContext
    {
        ...
        public virtual int usp_FindTotalSupplierIncomes(string supplierName, Nullable<System.DateTime> startDate, Nullable<System.DateTime> endDate, ObjectParameter result)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("usp_FindTotalSupplierIncomes", supplierNameParameter, startDateParameter, endDateParameter, result);
        }
    
        public virtual int FindTotalSupplierIncomes(string supplierName, Nullable<System.DateTime> startDate, Nullable<System.DateTime> endDate, ObjectParameter result)
        {
            var supplierNameParameter = supplierName != null ?
                new ObjectParameter("supplierName", supplierName) :
                new ObjectParameter("supplierName", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("FindTotalSupplierIncomes", supplierNameParameter, startDateParameter, endDateParameter, result);
        }
    }
}
